 ...
 */
defineMiddlewares(
  { region: 'api', scope: 'recomputeRecommendationStats', routeId: 'recomputeRecommendationStats' },
  [
    { id: 'recomputeStats', after: ['escapeHtml', 'auth'], before: ['apiResponse'], handler: recomputeStats }
  ]
);

...
import deleteCmsPage from './deleteCmsPage.js';
 ...
 */
defineMiddlewares(
  { region: 'api', scope: 'deleteCmsPage', routeId: 'deleteCmsPage' },
  [
    { id: 'deleteCmsPage', after: ['escapeHtml', 'auth'], before: ['apiResponse'], handler: deleteCmsPage }
  ]
);

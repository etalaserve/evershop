 ...
 *
 * Serves the canonical `/admin/page-builder/edit/:routeId`. It replaced a
 * widget-table editor at this same URL, which is why every existing link kept
 * working through the swap — `pageBuilderEditUrl`, the landing-page button,
 * the route picker and the rollout session picker all already pointed here.
 * `/admin/page-builder/puck/:routeId`, where this was built, now redirects in.
 *

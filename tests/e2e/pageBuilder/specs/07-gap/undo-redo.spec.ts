...
// PUCK MIGRATION STATUS: COVERED by 00-migration/puck-publish-undo.spec.ts (undo retreats and redo
// re-advances the route cursor, verified from a fresh request).
